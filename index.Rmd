...
Uitleg: Chroma & Timbre Analyse

- **Chroma Self-Similarity:** Deze plot visualiseert de harmonische structuur van een muziekstuk. Patronen in de chroma zelf-similariteit kunnen wijzen op herhaalde akkoorden of toonladders.
- **Timbre (MFCC) Self-Similarity:** Dit representeert de klankkleur van de muziek. Variaties in timbre kunnen verband houden met instrumentatie, dynamiek en mixtechnieken.

Door beide visualisaties naast elkaar te plaatsen, kunnen we verbanden leggen tussen harmonische en timbrale structuren in een nummer.
